...
class LevelSelectionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    debugPrint(
        'LevelSelectionScreen highestScore = ${playerProgress.highestScoreReached}, highestLevel = ${playerProgress.highestLevelReached}');
      ...
      body: ResponsiveScreen(
        ...
        rectangularMenuArea: Column(
          children: [
            ...
            _gap(),
            kIsMobile ? Container() : _backWidget(context),
          ],
        ),
      ),
    );
  ...
  SizedBox _gap() => kIsMobile ? SizedBox(height: 0) : SizedBox(height: 50);
  ...
  TextStyle enabledDisabledStyle(PlayerProgress playerProgress, GameUniverse universe, Palette palette) {
    TextStyle responsiveTitle = kIsMobile ? palette.subtitleMobile : palette.subtitle;
    TextStyle responsiveTitleDisabled = kIsWeb ? palette.subtitleMobileDisabled : palette.subtitleDisabled;
